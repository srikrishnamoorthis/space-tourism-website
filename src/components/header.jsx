                ...
                <ul className="mt-24 md:mt-0 md:flex md:gap-12 md:items-center md:h-full">
                    <li className='px-16 pb-8 md:px-0 md:pb-0 md:h-full'>
                        <NavLink
                            ...
                            <><span className='pr-2 font-semibold'>00</span>HOME</>
                        </NavLink>
                    </li>
                    <li className='px-16 pb-8 md:px-0 md:pb-0 md:h-full'>
                        <NavLink
                            to='/destination'
                            className={({ isActive }) => classnames('no-underline md:h-full md:flex md:items-center md:hover:border-b hover:border-white', { 'md:border-b-2 md:border-white': isActive })}>
                            <><span className='pr-2 font-semibold'>03</span>DESTINATION</>
                        </NavLink>
                    </li>
                    <li className='px-16 pb-8 md:px-0 md:pb-0 md:h-full'>
                        <NavLink
                            to='/crew'
                            className={({ isActive }) => classnames('no-underline md:h-full md:flex md:items-center md:hover:border-b hover:border-white', { 'md:border-b-2 md:border-white': isActive })}>
                            <><span className='pr-2 font-semibold'>03</span>CREW</>
                        </NavLink>
                    </li>
                    <li className='px-16 pb-8 md:px-0 md:pb-0 md:h-full'>
                        <NavLink
                            to='/technology'
                            className={({ isActive }) => classnames('no-underline md:h-full md:flex md:items-center md:hover:border-b hover:border-white', { 'md:border-b-2 md:border-white': isActive })}>
                            <><span className='pr-2 font-semibold'>03</span>TECHNOLOGY</>
                        </NavLink>
                    </li>
                </ul>
            </div>
